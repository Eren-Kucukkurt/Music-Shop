...
import DeliveryListPage from './components/DeliveryListPage.js'; // Update the path if DeliveryListPage is in a different directory
  ...
  return (
    <div className="App">
      ...
      <Routes>
        ...
        <Route path = "/productManager/delivery" element = {<DeliveryListPage />} />
      </Routes>
    </div>
  );
}
